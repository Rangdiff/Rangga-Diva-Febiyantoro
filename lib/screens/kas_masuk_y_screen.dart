...
class KasMasukYScreen extends StatefulWidget {
  const KasMasukYScreen({super.key});

  @override
  State<KasMasukYScreen> createState() => _KasMasukYScreenState();
}

class _KasMasukYScreenState extends State<KasMasukYScreen> {
